# Corrida general del Workflow de semillerios
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    extra_trees = FALSE,
    #No estaban
    feature_fraction_bynode = c( 0.8, 1.0 ),
    use_quantized_grad = TRUE,
    num_grad_quant_bins = c( 2L, 4L, "integer"),
    stochastic_rounding = TRUE,
    # White Gloves Bayesian Optimization, with a happy narrow exploration
    learning_rate = c( 0.01, 0.5 ), #Baseline
    feature_fraction = c( 0.2, 0.9 ),
    num_leaves = c( 8L, 2048L,  "integer" ), #Baseline
    min_data_in_leaf = c( 100L, 2000L, "integer" ) #Baseline
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT000167", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA000167", "DT000167" )

  DR_drifting_baseline( "DR000167", "CA000167" )
  FE_historia_baseline( "FE000167", "DR000167" )

  TS_strategy_baseline_202109( "TS000167", "FE000167" )

  HT_tuning_baseline( "HT000167", "TS000167" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem67", c("HT000167","TS000167") )
...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS000267", "FE000167" )

  HT_tuning_baseline( "HT000267", "TS000267" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem67", c("HT000267","TS000267") )
...
corrida_baseline_semillerio_202109( "basem01b67" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem02b67" )
